export const KeyBQuestions = {
  B01: {
    question: '01. Selecione a consistência do cogumelo:',
    choices: [
      {
        id: '1',
        label: 'Consistência carnosa ou carnosa-putrescente.',
      },
      {
        id: '2',
        label: 'Consistência com outras características (seca).',
      },
    ],
  },
  B02: {
    ...
    choices: [
      ...
      {
        id: 'Suillus luteus',
        label: `Com as características do anterior, mas lado superior marrom e com restos do véu parcial. Espécie comestível.`,
      },
      {
        id: 'Suillus cothurnatus',
        label: `Parecido com o anterior, mas de tamanho um pouco menor e com o contexto (carne) cor-de-laranja pálido quando fresco. Espécie comestível.`,
      },
      {
        id: '4',
        label: 'Corpos frutíferos com cabeça.',
      },
    ],
  },
  B03: {
    question: '03. Selecione a característica do cogumelo:',
    choices: [
      {
        id: '1',
  ...
  B04: {
    question: '04. Selecione a característica do parasitismo:',
    choices: [
      {
        id: 'Claviceps spp.',
        label: `Parasitas de vegetais superiores, geralmente em espigas de gramíneas onde se formam nos lugares dos ovários.`,
      },
      {
        id: 'Cordyceps spp.',
        label: `Parasitas de insetos (adultos ou larvas) e aranhas, geralmente enterrados no solo.`,
      },
    ],
  },
  B05: {
    question: '05. Selecione a característica da cabeça e do estípite:',
    choices: [
      {
        id: 'Itajahia galericulata',
        label: `Cabeça coberta por massa de esporos de cor verde-olivácea. Estípite branco. Espécie não comestível.`,
      },
      {
      ...
      },
      {
        ...
        label: `Cabeça reticulada de cor salmão. Massa viscosa de esporos marrons entre as malhas da rede. Estípite rosado. Não comestível.`,
      },
    ],
  },
  B06: {
    question: '06. Selecione a característica das frutificações:',
    choices: [
      {
        id: '1',
        label: `Frutificações em estromas.`,
      },
      {
        id: '2',
        label: `Frutificações não em estromas.`,
      },
    ],
  },
  B07: {
    question: '07. Selecione a característica dos estromas:',
    choices: [
      {
        id: 'Balansia claviceps',
        label: `Estromas pequenos (menores que 0.5mm), capitados. Estípite curto. Agrupados sobre folhas de gramíneas.`,
      },
      {
        id: '2',
        label: `Estromas maiores (2 a 5mm).`,
      },
    ],
  },
  B08: {
    question: '08. Selecione a característica dos estromas e da cabeça:',
    choices: [
      {
        id: 'Poronia oedipus',
  ...
  B09: {
    question: '09. Selecione a característica dos corpos frutíferos:',
    choices: [
      {
      ...
      {
        id: '2',
        label: `Corpos frutíferos com chapéu. Lado inferior com poros.`,
      },
    ],
  },
  B10: {
    question: '10. Selecione a característica do estípite e das frutificações:',
    choices: [
      {
        id: '1',
        label: `Com estípite central. Frutificações de consistência coriácea a carnosa-fibrosa.`,
      },
      {
        id: '2',
        label: `Com estípite lateral. Frutificações de consistência sublenhosa, resistente.`,
      },
    ],
  },
  B11: {
    question: '11. Selecione a característica dos corpos frutíferos e do estípite:',
    choices: [
      {
      ...
      },
      {
        ...
        label: `Corpos frutíferos carnosos-fibrosos, de cor clara. Altura do estípite maior que o diâmetro do chapéu. Encontrados sobre madeira.`,
      },
    ],
  },
  B12: {
    question: '12. Selecione a característica do estípite:',
    choices: [
      {
        id: 'Amauroderma sp.',
      ...
      {
        id: '2',
        label: `Estípite de outras cores.`,
      },
    ],
  },
  B13: {
    question: '13. Selecione a característica do cogumelo:',
    choices: [
      {
